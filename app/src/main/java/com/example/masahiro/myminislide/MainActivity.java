package com.example.masahiro.myminislide;
...
public class MainActivity extends AppCompatActivity {
    ...
    int[] mImageResources = {R.drawable.s01,
            R.drawable.s02,
            R.drawable.s03,
            R.drawable.s04,
            R.drawable.s05};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMediaPlayer = MediaPlayer.create(this,R.raw.decade);
    ...
    public void onSlideshowButtonStopped(View view){
        mIsSlideshow = !mIsSlideshow;
        mMediaPlayer.pause();
